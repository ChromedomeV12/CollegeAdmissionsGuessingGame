(function (root) {
  ...
  const en = {
    ...
    "menu.description": "A focused library of applicant profiles. No endless feed, no public usernames, just the evidence and your prediction.",
  ...
  const zhCN = {
    ...
    "common.cancel": "取消",
    "menu.eyebrow": "招生阅览室",
    "menu.description": "一个精简而专注的申请档案库。没有无尽的信息流，也没有公开用户名，只有证据和你的预测。",
