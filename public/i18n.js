(function (root) {
  ...
  const en = {
    ...
    "home.copy": "Predict where an applicant got in, then see how close your read was to the real outcome.",
    "home.rulesLabel": "How to play",
    "home.scoreStrong": "0–100 points",
    "home.scoreBody": "Match the best university and LAC band, then pick the admits inside your chosen bands.",
    "home.retryStrong": "One scoring retry",
    "home.retryBody": "Your first reveal opens a five-second retry window. After that, the case is practice only.",
    "home.paceStrong": "Time matters",
    "home.paceBody": "Faster reads score higher, up to the 100-point cap per case.",
    ...
    "menu.description": "A focused library of applicant profiles. Just the evidence and your prediction.",
    "menu.libraryLabel": "Case library",
    "menu.selectApplicant": "Select an applicant",
    "menu.progressLabel": "Case library progress",
    "menu.seedCases": "Profiles",
    "menu.completed": "Completed",
    "menu.applicant": "Applicant {num}",
    "menu.selectAria": "Select applicant {num}, {name}{status}{practice}",
    ...
    "profile.displayName": "Profile {number}",
    ...
    "reveal.celebrationGreat": "Nailed it.",
    "reveal.celebrationGood": "Solid read.",
  ...
  const zhCN = {
    ...
    "home.play": "开始游戏",
    "home.kicker": "读档案，下判断。",
    "home.copy": "预测申请人被哪所学校录取，再看你的判断离真实结果有多近。",
    ...
    "common.loading": "加载中…",
    "menu.eyebrow": "招生阅览室",
    "menu.description": "一个精简而专注的申请档案库。只有证据和你的预测。",
    ...
    "reveal.celebrationGreat": "看准了。",
    "reveal.celebrationGood": "读得不错。",
    "reveal.celebrationAccuracy": "录取判断准确率 {accuracy}%，这份档案你读懂了。",
    "reveal.celebrationScore": "本案件得分：{score}/100。",
    ...
    "leaderboard.avg": "平均分",
    "leaderboard.noScores": "还没有分数，来当第一个。",
    ...
    "menu.selectAria": "选择申请人 {num}，{name}{status}{practice}",
    ...
    "leaderboard.rivalEmpty": "还没有对手。添加玩家用户名，开启对决，比较你们共同完成的案件。",
